...
bool CNFStaticDataManager::ReadProtagonistStaticFromDB()
{
    ...
    log("CNFStaticDataManager::ReadProtagonistStaticFromDB Run Error! Msg=%s ",szErrMsg);
    return false;
}
...
bool CNFStaticDataManager::ReadEnemyStaticFromDB()
{
    ...
    log("CNFStaticDataManager::ReadEnemyStaticFromDB Run Error! Msg=%s ",szErrMsg);
    return false;
}
...
bool CNFStaticDataManager::ReadEnemyAIStaticFromDB()
{
    ...
    log("CNFStaticDataManager::ReadEnemyAIStaticFromDB Run Error! Msg=%s ",szErrMsg);
    return false;
}
...
bool CNFStaticDataManager::ReadSkillStaticFromDB()
{
    ...
    log("CNFStaticDataManager::ReadSkillStaticFromDB Run Error! Msg=%s ",szErrMsg);
    return false;
}
...
bool CNFStaticDataManager::ReadWaveStaticFromDB()
{
    ...
    log("CNFStaticDataManager::ReadWaveStaticFromDB Run Error! Msg=%s ",szErrMsg);
    return false;
}
...
bool CNFStaticDataManager::ReadEquipStaticFromDB()
{
    ...
    log("CNFStaticDataManager::ReadEquipStaticFromDB Run Error! Msg=%s ",szErrMsg);
    return false;
}
...
bool CNFSaveDataManager::ReadSaveUserFromDB()
{
    ...
    log("CNFSaveDataManager::ReadSaveUserFromDB Run Error! Msg=%s ",szErrMsg);
    return false;
}
...
bool CNFSaveDataManager::SetSaveServerInfo(tagSaveServerInfo ServerInfo)
{
    ...
    log("CNFSaveDataManager::SetSaveServerInfo Run Error! Msg=%s",szErrMsg);
    return false;
}
...
bool CNFSaveDataManager::ReadSaveServerFromDB()
{
    ...
    log("CNFSaveDataManager::ReadSaveServerFromDB Run Error! Msg=%s ",szErrMsg);
    return false;
}
