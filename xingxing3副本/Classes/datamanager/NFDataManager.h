...
protected:
    ...
    /**主角静态信息*/
    CNFProtagonistStaticInfoMap				m_ProtagonistStaticInfoMap;
    
    /**敌人静态信息*/
    CNFEnemyStaticInfoMap					m_EnemyStaticInfoMap;
   
    /**物品静态信息*/
    CNFArticleStaticInfoMap					m_ArticleStaticInfoMap;
    
    /**敌人AI静态信息*/
    CEnemyAIStaticInfoMap					m_EnemyAIStaticInfoMap;
    
    /**升级所需经验静态信*/
    CNFLevelUpExpStaticInfoMap				m_LevelUpexpStaticInfoMap;
    
    /**波次静态信息*/
    CNFStageWaveInfoMap						m_StageWaveStaticInfoMap;
    
    /**装备静态信息*/
    CNFEquipStaticInfoMap					m_EquipStaticInfoMap;
